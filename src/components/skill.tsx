  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {/* Icon container */}
        <div className="relative flex h-10 w-10 items-center justify-center rounded-xl border border-slate-700/50 bg-slate-800/50 transition-all duration-300 group-hover:border-cyan-500/40 group-hover:bg-slate-800/80 md:h-12 md:w-12">
