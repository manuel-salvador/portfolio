...
export const MainProjects: ProjectType[] = [
  ...
  },
  {
    ...
    description:
      'DApp for matchmaking and betting coordination in sporting events between non-professional sports teams developed in Think & Dev Hackathon 2.0',
  },
];
...
export const AllProjects: ProjectType[] = [
  ...
  },
  {
    ...
    description:
      "Smart contract of a crowdfunding developed during Platzi's Introduction to Blockchain Development course.",
  },
  {
    ...
    description:
      'CLI tool to quickly create a Next.js project using TypeScript and Tailwind, without the app directory. Web3 option installs RainbowKit.',
  },
  {
  ...
  },
  {
    ...
    description: 'My alternative portfolio with simple design',
  },
];
